...
async function broadcastUpdate() {
    try {
        ...
        const message = {
            notification: {
                title: 'ASTRA v3.3.1: Stabilization Hotfix ❄️',
                body: 'Resolved persistent UI freezing issues. This update stabilizes the Registration flow, QR Scanner, and Calculator. Highly recommended for all students.',
            },
            data: {
                type: 'update_alert'
            },
